            ...
            <div className="container">
                ...
                <div style={{ position: "relative" }}>
                    ...
                    >
                        ...
                        <div className="d-flex text-white w-100 mx-3 rounded-md" style={{ background: "URL(/img/limited.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "270px" }}><p className="mx-auto fs-2 my-auto">Limited Edition</p></div>
                    </Carousel>
                </div>
            </div>
