...
import { AddProductSeller } from '../../src/component/module'
                ...
                <div className="w-100-sm w-60-lg">
                  ...
                  <div className="w-100 d-flex mb-3">
                    ...
                    <div className="ms-3" style={{ width: "70%" }}>
                      <input disabled={state.youWantToEdit === true ? false : true} type="text" placeholder="write your name..." className="p-2 border rounded w-100" style={{ outline: "none" }} value={dataProfil.storeName} onChange={(e) => { setDataProfil({ ...dataProfil, storeName: e.target.value }) }} />
                    </div>
                  </div>
                  <div className="w-100 d-flex mb-3">
                    <div style={{ width: "30%" }}>
                    ...
                    <div className="ms-3" style={{ width: "70%" }}>
                      <input disabled={state.youWantToEdit === true ? false : true} type="text" placeholder="write your Email..." className="p-2 border rounded w-100" style={{ outline: "none" }} value={dataProfil.email} onChange={(e) => { setDataProfil({ ...dataProfil, email: e.target.value }) }} />
                    </div>
                  </div>
                  <div className="w-100 d-flex mb-3">
                    <div style={{ width: "30%" }}>
                    ...
                    <div className="ms-3" style={{ width: "70%" }}>
                      <input disabled={state.youWantToEdit === true ? false : true} type="number" placeholder="write your password..." className="p-2 border rounded w-100" style={{ outline: "none" }} value={dataProfil.phoneNumber} onChange={(e) => { setDataProfil({ ...dataProfil, phoneNumber: e.target.value }) }} />
                    </div>
                  </div>
                  <div className="w-100 d-flex mb-3">
                    <div style={{ width: "30%" }}>
                    ...
                    <div className="ms-3" style={{ width: "70%" }} >
                      <textarea disabled={state.youWantToEdit === true ? false : true} rows={5} className="p-2 border w-100" style={{ outline: "none" }} value={dataProfil.storeDesc} onChange={(e) => { setDataProfil({ ...dataProfil, storeDesc: e.target.value }) }} />
                    </div>
                  </div>
