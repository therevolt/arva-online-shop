                    ...
                    <div className="row">
                        <div className="col-10 col-lg-3">
                            <div className="d-flex">
                                <Image src="/assets/logo.png" width={34} height={44} />
                        ...
                        <div className={state.isLogin == false ? "col-3 col-lg-4 ms-auto hide-sm show-lg" : "hide"} >
                            <div className="d-flex justify-content-end">
                                <button class="material-icons bg-transparent border-0 my-auto me-4 color-gray">add_shopping_cart</button>
                                <button className="bg-danger text-white border-0 rounded-pill px-4 py-2 me-3">Login</button>
                                <button className="bg-danger text-white border-0 rounded-pill px-4 py-2" >Signup</button>
                            </div>
                        </div>
                        {/* -------- */}
                        ...
                        <div className={state.isLogin == true ? "col-3 col-lg-4 ms-auto hide-sm show-lg" : "hide"}>
                            <div className="d-flex justify-content-end">
                                ...
                                <button className="rounded-circle overflow-hidden bg-transparent border-0" style={{ width: "50px", height: "50px" }}>
                                    <Image src="/assets/profil.png" width={50} height={50} layout="responsive" />
                                </button>
                            </div>
                        </div>
                        {/* -------- */}
